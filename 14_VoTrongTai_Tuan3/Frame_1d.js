...
export default function Frame_1d() {
  return (
    <View style={styles.container}>
      ...
      <View style={styles.list}>
        <View style={styles.media}>
          <Image source={require("./assets/icofacebook1.png")} style={styles.eyeIcon} />
        </View>
        <View style={styles.media}>
          <Image source={require("./assets/icozalo.png")} style={styles.eyeIcon} />
        </View>
        <View style={styles.media}>
          <Image source={require("./assets/icogoogle1.png")} style={styles.eyeIcon} />
        </View>
      </View>
    </View>
  );
